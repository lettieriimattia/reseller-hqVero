...
SB DUNK GRAIL/RARE (valgono MIGLIAIA di €): Freddy Krueger (rosso/verde a righe stile maglione + suola "sangue", mai rilasciata ufficialmente), Heineken (verde/rosso/bianco birra), Pigeon NYC (grigio/arancio, Jeff Staple), Paris (Bernard Buffet multicolor pittura), Reese Forbes Denim, FLOM "What The Dunk", Supreme Stars/Rumpus, De La Soul, Unkle, Buck (cervo), Send Help.
⚠️⚠️ REGOLA CRITICA (letta ATTENTAMENTE): nomina una di queste SOLO se riconosci con ASSOLUTA CERTEZZA la grafica ESATTA e INCONFONDIBILE descritta sopra — non basta "sembra colorata", "ha strisce" o "pattern insolito". Se hai ANCHE SOLO UN MINIMO dubbio, NON nominarla: rispondi con la colorway generica che vedi (es. "grey/red", "multicolor") e lascia "collaboration" null. Sbagliare qui è GRAVISSIMO: inventare "De La Soul" o "Freddy Krueger" su una Dunk normale gonfia il prezzo di 10-50x e produce un dato falso mostrato come certo. È MOLTO meglio sottostimare (colorway generica) che inventare un grail che non c'è. In caso di dubbio: SEMPRE generico, MAI il nome della rara.
